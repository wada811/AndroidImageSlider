...
public class FadeAniamtion implements InOutAnimation {

    private InOutAnimations mInOutAnimation;

    public FadeAniamtion(Context context) {
        Animation inAnimation = AnimationUtils.loadAnimation(context, R.anim.fade_in);
