...
public class SlideRightToLeftAniamtion implements InOutAnimation {

    private InOutAnimations mInOutAnimation;

    public SlideRightToLeftAniamtion(Context context) {
        Animation inAnimation = AnimationUtils.loadAnimation(context, R.anim.slide_in_right);
        Animation outAnimation = AnimationUtils.loadAnimation(context, R.anim.slide_out_left);
