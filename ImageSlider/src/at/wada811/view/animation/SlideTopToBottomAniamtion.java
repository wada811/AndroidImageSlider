...
public class SlideTopToBottomAniamtion implements InOutAnimation {

    private InOutAnimations mInOutAnimation;

    public SlideTopToBottomAniamtion(Context context) {
        Animation inAnimation = AnimationUtils.loadAnimation(context, R.anim.slide_in_top);
        Animation outAnimation = AnimationUtils.loadAnimation(context, R.anim.slide_out_bottom);
